...
<body>
    <header class="navbar" id="main-nav">
        ...
        <nav id="menu-container">
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    <a href="../Academics/index.php" style="color:aliceblue">Academics <span class="arrow">▼</span></a>
    ...
    <main>
        <section class="aca">
            <h1>Academics</h1>
            <div class="option">
                <a href="IoT/index.php">IoT System and information</a>
                <a href="ComIoT/index.php">Computer Engineering & IoT</a>
                <a href="Gened1/index.php">GenEd</a>
            </div>
        </section>
    </main>
